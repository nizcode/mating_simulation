...
m10<-fem[c(which(fem[,3]==1)),]
m10<-rbind(m10,fem[c(which(fem[,3]==0)),])


#m0<-matrix(m0,ncol = 3)
m10<-matrix(m10,ncol = 3)
m2<-matrix(m2, ncol = 3)

m10mix<-sample(1:co10,co10)
m10mix<-m10[c(m10mix),1]

#m102mix<-sample(1:co102,co102)
#m102mix<-fem[c(m102mix),1]
